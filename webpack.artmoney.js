...
module.exports = (env, args) => {
  ...
  const config = {
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin({
        title: 'Займы',
        filename: 'am-calc.html',
        template: path.resolve(__dirname, 'src/am-calc.ejs'),
        templateParameters: siteParam,
        alwaysWriteToDisk: true,
      }),
      new HtmlWebpackPlugin({
        title: 'Контакты',
        filename: 'am-contacts.html',
        template: path.resolve(__dirname, 'src/am-contacts.ejs'),
        templateParameters: siteParam,
        alwaysWriteToDisk: true,
      }),
      new HtmlWebpackPlugin({
        title: 'Лицензии',
        filename: 'am-licenses.html',
        template: path.resolve(__dirname, 'src/am-licenses.ejs'),
        templateParameters: siteParam,
        alwaysWriteToDisk: true,
      }),
      new HtmlWebpackPlugin({
        title: 'Отзывы',
        filename: 'am-reviews.html',
        template: path.resolve(__dirname, 'src/am-reviews.ejs'),
        templateParameters: siteParam,
        alwaysWriteToDisk: true,
      }),
      new HtmlWebpackPlugin({
        title: 'Новость',
        filename: 'am-news.html',
        template: path.resolve(__dirname, 'src/am-news.ejs'),
        templateParameters: siteParam,
        alwaysWriteToDisk: true,
      }),
